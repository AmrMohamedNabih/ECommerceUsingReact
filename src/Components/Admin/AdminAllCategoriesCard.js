    ...
    return (
        <Col xs="12" sm="6" md="5" lg="4" className="d-flex">
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body><div className='font'>Are you sure you want to delete this category?</div></Modal.Body>
                <Modal.Footer>
            ...
            <Card
                ...
                <Row className="d-flex justify-content-center px-2">
                    <Col className="d-flex justify-content-between">
                        ...
                        <Link to={`/admin/editcategory/${item._id}`} style={{ textDecoration: "none" }}>
